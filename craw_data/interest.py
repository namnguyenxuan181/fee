...
scb_ptl_url = 'https://www.scb.com.vn/vie/detaillist/qa_interestrate_detail/QA_INTERESTRATE_SAVING_PHATLOCTAI/0'  # phat tai loc
...
scb_online_url = "https://www.scb.com.vn/vie/detaillist/qa_interestrate_detail/QA_INTERESTRATE_ONLINE_DEPOSIT/0"  # online
...
scb_online_interest_df = pd.DataFrame(scb_online_interest[3:],
                                      columns=['ky_han', 'linh_lai_truoc', 'linh_hang_thang', 'linh_cuoi_ky'])
...
# final result
interest_df = vcb_interest_df.append(pv_interest_df, ignore_index=True).append(scb_interest_df, ignore_index=True).append(bidv_hn_interest,ignore_index=True )